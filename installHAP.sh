...
#you can test if everything works with the following line,
#but normally you should run the server with "sudo forever start /home/pi/HAP-NodeJS/BridgedCore.js"
